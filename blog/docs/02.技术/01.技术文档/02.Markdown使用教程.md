...
语法：
[![github](https://img.shields.io/badge/github-don-brightgreen.svg)]()
```
[![github](https://img.shields.io/badge/github-don-brightgreen.svg)]()
...
```markdown
![其他仓库的图片1](/vue-music/raw/master/src/common/image/default.png)
或
![其他仓库的图片2]()
...
![其他仓库的图片](/vue-music/raw/master/src/common/image/default.png)
